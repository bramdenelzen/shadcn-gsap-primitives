...
export function DefaultVariantsSection() {
  return (
    <section>
      <TextReveal triggerOnView once={false} variant={"slideUp"} splitBy="line">
        <Typography variant="h2">Default variants</Typography>
      </TextReveal>
      <TextReveal variant={"slideUp"} splitBy="line" once={false}>
        ...
        {sections.map((section) => (
          <li key={section.title} className="space-y-6">
            <div className="space-y-1">
              <TextReveal once={false} variant={"slideUp"}>
            ...
            <div className="grid gap-6">
              {section.items.map((item) => (
                <FadeIn delay={0.5} customDuration={6} key={item.title} once={false} variant={"slideUp"}>
